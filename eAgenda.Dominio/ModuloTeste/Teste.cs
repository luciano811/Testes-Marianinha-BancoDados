...
namespace Testes_da_Mariana.Dominio.ModuloTeste
{
    ...
    {
        public List<Questao> _questoes = new List<Questao>();
        public int NumeroQuestoes { get; set; }
        public string Titulo { get; set; }
        public Disciplina Disciplina { get; set; }
        public Materia Materia { get; set; }
        public DateTime Data { get; set; }
        public List<Questao> Questoes { get => _questoes; set => _questoes = value; }
        ...
        public void AdicionarQuestaoT(Questao questaoParaInserir)
        {            
            if (_questoes.Exists(x => x.Equals(questaoParaInserir)) == false)
                _questoes.Add(questaoParaInserir);
        }
